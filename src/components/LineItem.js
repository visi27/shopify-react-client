...
class LineItem extends Component {
  ...
  render() {
    const moneyFormat = this.props.moneyFormat ? this.props.moneyFormat : "Lek {{amount}}";

    const totalValueRAW = (this.props.line_item.quantity * this.props.line_item.variant.price).toFixed(2);
    const totalValue = moneyFormat.replace('{{amount}}', totalValueRAW);
